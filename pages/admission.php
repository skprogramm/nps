...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $guirdian_name    = trim(filter_input(INPUT_POST, 'guirdian_name', FILTER_SANITIZE_STRING));
...
<head>
    ...
    <title>Admission Form | NPS Education</title>
    ...
    <div class="form-container">
        <div class="form-card w-full max-w-2xl p-8">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-800 mb-2">Join NPS Education</h1>
            ...
            <form action="" method="POST" id="admissionForm">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="guirdian_name" placeholder="Guardian Name" class="input-field" value="<?= htmlspecialchars($_POST['guirdian_name'] ?? '') ?>">
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div class="input-group">
                        ...
                        <select name="qualification" class="input-field" required>
                            <option value="">Select Qualification</option>
                            <option value="8th Pass" <?= ($_POST['qualification'] ?? '') === '8th Pass' ? 'selected' : '' ?>>8th Pass</option>
                            <option value="10th Pass" <?= ($_POST['qualification'] ?? '') === '10th Pass' ? 'selected' : '' ?>>10th Pass</option>
                            <option value="12th Pass" <?= ($_POST['qualification'] ?? '') === '12th Pass' ? 'selected' : '' ?>>12th Pass</option>
                            <option value="Graduate" <?= ($_POST['qualification'] ?? '') === 'Graduate' ? 'selected' : '' ?>>Graduate</option>
                            <option value="Post Graduate" <?= ($_POST['qualification'] ?? '') === 'Post Graduate' ? 'selected' : '' ?>>Post Graduate</option>
